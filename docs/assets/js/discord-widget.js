// Discord Widget - Floating Member Count
(function() {
    ...
    widget.innerHTML = `
        <a href="https://discord.gg/GKy9htGXau" target="_blank" rel="noopener noreferrer" class="discord-widget-link">
            ...
            <div class="discord-widget-content">
                <div class="discord-widget-label">Join our Discord</div>
                <div class="discord-widget-count" id="discord-member-count">
    ...
    async function updateMemberCount() {
        try {
            ...
            countElement.innerHTML = `<strong>${memberCount}</strong> members online`;
        } catch (error) {
            console.warn('Discord widget error:', error);
            const countElement = document.getElementById('discord-member-count');
            countElement.textContent = 'Join us!';
        }
    }
